...
from util import initialize_indices, get_balance_index, get_spending_index, get_full_index
...
def query_index():
    ...
    # build chat engine
    chat_engine = full_index.as_chat_engine(chat_mode="openai", 
                                            verbose=True,
    ...
    response = chat_engine.chat(query_text, function_call="query_engine_tool")
