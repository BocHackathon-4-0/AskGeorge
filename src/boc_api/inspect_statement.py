...
def retrieveStatement(subId, consentToken, accountNo):
    url = f"https://sandbox-apis.bankofcyprus.com/df-boc-org-sb/sb/psd2/v1/accounts/{accountNo}/statement?maxCount=100"
