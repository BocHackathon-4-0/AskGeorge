...
def updateSubscription(subscription, authCode):
    url = f"https://sandbox-apis.bankofcyprus.com/df-boc-org-sb/sb/psd2/v1/subscriptions/{subscription['subscriptionId']}"

    payload = json.dumps(subscription)
    headers = {
    'Authorization': f'Bearer {authCode}',
    'Content-Type': 'application/json',
    'originUserId': '{{header_origin_user_id}}',
    'timeStamp': str(int(time())),
    'journeyId': 'BOC_EUC_B2B_LIVE',
